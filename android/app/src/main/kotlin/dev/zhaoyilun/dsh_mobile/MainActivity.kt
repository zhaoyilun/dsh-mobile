package dev.yourname.dsh_mobile
...
class MainActivity : FlutterActivity() {
    companion object {
        private const val CHANNEL = "dev.yourname.dsh_mobile/notifications"
        private const val FILE_CHANNEL = "dev.yourname.dsh_mobile/files"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // The file-selector channel the Dart half actually calls
        // (home_page.dart: MethodChannel('dev.yourname.dsh_mobile/files')).
        // Without this registration the WebView's <input type=file> callbacks
        // vanished as MissingPluginException and the picker never opened.
        MethodChannel(
            flutterEngine.dartExecutor.binaryMessenger,
            FILE_CHANNEL,
        ).setMethodCallHandler { call, result ->
