...
export function InputBar({
  ...
  const [mobileShell] = useState(() => typeof document !== 'undefined' && document.querySelector('[data-mobile-shell]') !== null)
  ...
  const onKeyDown = (e: KeyboardEvent<HTMLTextAreaElement>): void => {
    ...
    // The mobile shell follows chat-app convention: plain Enter also inserts a
    // newline; submission is the visible send button, never a hidden keyboard chord.
    if (e.key === 'Enter' && (e.shiftKey || mobileShell)) return
