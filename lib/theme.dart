...
class DshTokens {
  ...
  // 品牌色。
  static const Color kleinBlue = Color(0xFF3B5BD9);
  static const Color kleinBlueDeep = Color(0xFF2E44AD);
...
ThemeData buildDshTheme({Brightness brightness = Brightness.light}) {
  ...
  return ThemeData(
    useMaterial3: true,
    colorScheme: scheme,
    // 选中高亮：暖橙 55%——浅底/深蓝底（用户气泡）上都与底色区分明显
    textSelectionTheme: TextSelectionThemeData(
      selectionColor: const Color(0x8CFFB84D),
      selectionHandleColor: DshTokens.kleinBlue,
    ),
